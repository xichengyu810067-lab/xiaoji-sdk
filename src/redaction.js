...
const USERINFO_URI_PATTERN = /\b[a-z][a-z0-9+.-]*:\/\/[^\s/"']+@[^\s"']*/gi;
const CONNECTION_PATTERN = /\b(?:wss?|postgres(?:ql)?|mysql|sqlite|redis(?:s)?|mongodb(?:\+srv)?|amqps?):(?:\/\/)?[^\s"']*/gi;
...
function redactString(value) {
  return value
    ...
    .replace(USERINFO_URI_PATTERN, '[REDACTED_CREDENTIAL_URI]')
